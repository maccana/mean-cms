A refactor of the MEAN CMS project. This is a work in progress that currently allows an existing Admin to login and perform CRUD operations on the site content (a set of pages visible to the public).
